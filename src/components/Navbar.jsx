  ...
  return (
    <div >
        <div className="relative bg-[#022738]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center border-b-2 border-gray-900 py-6 md:justify-start md:space-x-10">
              ...
              <Link to={"/about"}
                ...
                <div className="relative">
                  <button
                    type="button"
                    className="
                     group bg-[#022738] rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 pb-8'
                    "
                  ...
                  >
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                      ...
                      <div className="px-5 py-5 bg-[#022738] space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                      ...
                      <a
                          href="#"
                          className="-m-3 p-3 flex items-start rounded-lg hover:bg-[#022738]"
                        >
                        ...
                        <div className="flow-root">
                          <a
                            href="#"
                            className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-[#022738]"
                          >
              ...
              <div className="relative">
                  <button
                    type="button"
                    className="group bg-[#022738] rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    onClick={() => (setFlyerThree(!flyerThree), setFlyer(false))}
                  >
                   
                    <img
                    className="h-8 w-auto sm:h-10"
                    src={percon_icon} alt='Person Icon'
                  />
          ...
          >
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-[#022738] divide-y-2 divide-gray-50">
